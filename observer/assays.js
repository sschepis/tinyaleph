 ...
 * 
 * These assays are designed to work with any observer implementation
 * that provides the required interface (getStats(), smf, memory, etc.)
 */
...
class TimeDilationAssay {
    constructor(observerCore) {
        this.core = observerCore;
        this.measurements = [];
        this.running = false;
    }
...
class AssaySuite {
    constructor(observerCore) {
        this.core = observerCore;
        this.timeDilation = new TimeDilationAssay(observerCore);
        this.memoryContinuity = new MemoryContinuityAssay(observerCore);
        this.agencyConstraint = new AgencyConstraintAssay(observerCore);
        this.nonCommutative = new NonCommutativeMeaningAssay(observerCore);
    }
    ...
    async runAll(options = {}) {
        ...
        console.log('OBSERVER EVALUATION ASSAY SUITE');
